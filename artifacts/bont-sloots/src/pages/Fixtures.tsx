...
export function Fixtures() {
  ...
  const renderFixture = (fixture: typeof fixtures[0]) => {
    ...
    return (
      <div key={fixture.id} className="bg-card border border-border/50 rounded-xl p-4 flex gap-4">
        <div className="flex flex-col items-center justify-center text-center w-16 border-r border-border/50 pr-4">
